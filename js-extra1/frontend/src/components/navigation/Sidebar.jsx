...
import { UserRound, Route, BriefcaseBusiness, LayoutDashboard, X, FileBadge2, PlusCircle, CalendarHeart, ScanSearch, Users } from "lucide-react";
        ...
        {sidebarOpen && (
          <>
            ...
            <motion.aside
              ...
              animate="visible"
              exit="exit"
              className="glass-panel fixed left-3 top-3 z-50 h-[calc(100vh-1.5rem)] w-[min(330px,92vw)] p-4"
            >
              {sidebarContent}
            </motion.aside>
          </>
